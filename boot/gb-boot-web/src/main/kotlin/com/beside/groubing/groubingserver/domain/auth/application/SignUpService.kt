...
import com.beside.groubing.groubingserver.domain.auth.domain.SignUpValidator
...
class SignUpService(
    ...
    fun signUp(signUpCommand: SignUpCommand): MemberResponse {
        ...
        return try {
            ...
            MemberResponse.of(savedMember, tokenManager.generateAccessToken(savedMember.id, savedMember.role.name))
