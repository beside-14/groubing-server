...
* link:friend/FriendChangeStatus.html[친구 요청 승낙 / 거부,window=_blank]
...
* link:blocked/BlockedMemberFind.html[차단 회원 목록 / 닉네임 검색,window=_blank]

[[member-blocking]]
=== 회원 차단 및 해제

* link:blocked/BlockingMember.html[회원 차단,window=_blank]

* link:blocked/UnblockingMember.html[회원 차단 해제,window=_blank]
