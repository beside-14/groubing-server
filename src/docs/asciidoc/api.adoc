...
요청 바디에 필요한 요소만 담아서 수정이 가능하도록 개발 되었습니다.
따라서 빙고 수정과 별개의 화면에서 진행되는 빙고 메모의 경우 수정할 메모 문자열만 담아서 보내주시면 됩니다.

operation::edit-bingo[snippets='http-request,request-fields,http-response,response-fields']
