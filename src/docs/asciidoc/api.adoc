...
* link:friendship/FriendshipFind.html[친구 목록 / 닉네임 검색,window=_blank]

[[friendship-add]]
=== 친구 요청

* link:friendship/FriendshipAdd.html[친구 요청,window=_blank]

[[friendship-change-status]]
=== 친구 요청 승낙 / 거부

* link:friendship/FriendshipChangeStatus.html[친구 요청 승낙 / 거부,window=_blank]
